...
def SOM(w,l):
    ...
    raw_data = ge1tPoints('haralick_no_human25_4 colornormalized.csv')


    network_dimensions = np.array([w, l])
    n_iterations = 100000
    ...
    def folderDist(resultList,typ,n):
        ...
        newpa = "C:\\Users\\al00993\\Documents\\GitHub\\FYP\\sprint4\\Classification\\SOM\data\\"
        num = 0
        splitt = '\\'
    ##    print("Hello",splitt)
    ...
    ##    print('n',n)
        for i in resultList:
            num += 1
            newpath = newpa  +'ClustersnewN' + str(typ) +str(n) + 'Label'+str(num)
            try:
                os.mkdir(newpath)
            except OSError:
