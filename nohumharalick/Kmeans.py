...
def folderDist(resultList,typ,n):
    searchPath = 'C:\\Users\\al00993\\Documents\\GitHub\\FYP\\nohumharalick\\imagesRenamed - NoHuman\\**\\*.jpg'
    newpa = "C:\\Users\\al00993\\Documents\\GitHub\\FYP\\nohumharalick\\Clusters174_7_3\\"
    num = 0
    splitt = '\\'
##    print("Hello",splitt)
...
def mainn(n):
    files = ['haralick_no_human174_7_3 colornormalized.csv']
    for i in files:
        for j in range(n):    
            a = main(i,j+2)
